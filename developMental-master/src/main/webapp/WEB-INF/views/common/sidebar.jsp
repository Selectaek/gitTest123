    ...
    <nav id="sidebar" class="p-0 flex-shrink-1">
      ...
      <ul class="list-unstyled components">
        ...
        <li>
         ...
         <li class="active">
          <a href="#freeboardSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle sidebar-dropdown-toggle">자유게시판</a>
          <ul class="collapse list-unstyled" id="freeboardSubmenu">
          	<li>
<%--               <a href="javascript: ajaxJobPage('${path }/freeboard/freeboardList.do');">Q&A</a> --%>
              <a href="${pageContext.request.contextPath}/freeboard/freeboardList.do">Q&A</a>
